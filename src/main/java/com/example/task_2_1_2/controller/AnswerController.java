...
public class AnswerController {
     ...
     */
    @GetMapping
    public ResponseEntity<List<Answer>> getAll(@RequestParam(defaultValue = "0") int page, @RequestParam(defaultValue = "10") int size) {
        return ResponseEntity.status(answerService.getAll(page, size).isEmpty() ? HttpStatus.NO_CONTENT : HttpStatus.FOUND).body(answerService.getAll(page, size));
    }
